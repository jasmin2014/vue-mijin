...
<template>
  <div class="base-information">
    <label @click="handleCloseBaseBox" class="close-icon">
      {{closeBase}}用户基本信息
      <i v-if="!isClose" class="el-icon-arrow-up"></i>
      <i v-else class="el-icon-arrow-down"></i>
    </label>
    <el-card class="top-box" v-show="!isClose">
      <el-form class="form-label flex fixed-width">
        <el-row class="topH3">
          <h3>用户基本信息</h3>
          <div v-if="partyPersonDTO.partyId">
            <router-link :to="{name: 'UserDetail', params: {id:partyPersonDTO.partyId,active: 'first'}}"
                         class="el-button el-button--text" title="查看历史授信记录"><span>查看历史授信记录</span></router-link>
            <router-link :to="{name: 'UserDetail', params: {id:partyPersonDTO.partyId,active: 'second'}}"
                         class="el-button el-button--text" title="查看历史借款记录"><span>查看历史借款记录</span></router-link>
          </div>
        </el-row>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8">
              <el-form-item label="开户类型">
                <mj-select v-model="accountDetailDTO.accountType" :mode="'VIEW'"
            ...
            <el-col :span="8">
              <el-form-item label="公司名称">
                <mj-input v-model="accountDetailDTO.orgName" :mode="'VIEW'"></mj-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="银行卡所属银行">
            ...
            <el-col :span="8">
              <el-form-item label="运营商认证">
                <mj-input v-model="certResult"
                          :mode="'VIEW'"></mj-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="20" class="credit-box">
            <h3><span>授信信息</span></h3>
            <el-col :span="8">
          ...
          <el-row :gutter="20" class="credit-box">
            ...
            <el-col :span="8">
              <el-form-item label="信用等级">
                <mj-select v-model="creditDTO.creditGrade"
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8">
              <el-form-item label="贷款用途">
                <mj-select v-model="creditDTO.loanPurpose"
            ...
            <el-col :span="8">
              <el-form-item label="还款来源">
                <mj-select v-model="creditDTO.payment"
            ...
            <el-col :span="8">
              <el-form-item label="年收入">
                <mj-select v-model="creditDTO.annualSalary"
          ...
          <el-row :gutter="20" class="credit-box">
            ...
            <el-col :span="6">
              <el-form-item label="借款利率">
                <mj-input v-model="creditDTO.loanRate" :mode="'VIEW'"
                          unit="%"></mj-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="还款方式">
                <mj-select v-model="creditDTO.repayWay"
    ...
    <div class="channel-tags">
      ...
      <a ref="jsShop" id="jsShop" target="_blank" :href="report5">生意参谋</a>
    </div>
  </div>
</template>

<script>
  import {getCreditBasicDetail, getLoanBasicDetail, getReportApi} from '../../api/risk'
  ...
  export default {
    ...
    computed: {
      certResult: {
        get() {
          return this.partyCertificateDTO.certResult == true ? '已认证' : this.partyCertificateDTO.certResult === false ? '未认证' : '';
        },
        set(val) {
    ...
    methods: {
      ...
      setReport(type, name, id, phone) {
        return this.report + 'report.html?type=' + type + '&name=' + name + '&idCard=' + id + '&phone=' + phone;
      },
      //授信用户基本详情
      ...
      setDatasource(res){
        ...
        if (res.accountDetailDTO != null) {
          ...
          this.$store.dispatch('saveParams', {
            key: 'accountType',
            val: this.accountDetailDTO.accountType
          })
        }
        if (res.creditDTO != null) {
          ...
          if (res.creditDTO.startDate || res.creditDTO.endDate) {
            this.creditDTO.auditDate = res.creditDTO.startDate + ' ~ ' + res.creditDTO.endDate;
          }
        }
