      ...
      <el-row>
        <el-col :span="7">
          <el-form-item label="当前还款状态">
            <mj-select v-model="search.repayStatus" :kind="this.$enum.REPAY_STATUS" :group="this.$enum.REPAY_STATUS" :sequence=[0,1] placeholder="请选择" clearable></mj-select>
          </el-form-item>
        </el-col>
        <el-col :span="4">
          <el-form-item>
