      ...
      <el-row>
        ...
        <el-col :span="10">
          <el-form-item label="放款时间">
            <el-date-picker v-model="payDate" value-format="yyyy-MM-dd" type="daterange" start-placeholder="开始日期"
                            end-placeholder="结束日期"
                            clearable>
            </el-date-picker>
          </el-form-item>
        ...
        <el-col :span="6">
          <el-form-item label="放款类型">
            <mj-select v-model="search.paymentType" :kind="this.$enum.LOAN_TYPE" :group="this.$enum.LOAN_TYPE"
                       clearable>
            </mj-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="放款状态">
            <mj-select v-model="search.paymentStatus" :kind="this.$enum.PAYMENT_STATUS"
                       :group="this.$enum.PAYMENT_STATUS" clearable>
            </mj-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="财务放款类型">
            <mj-select v-model="search.financePaymentType" :kind="this.$enum.FINANCIAL_TYPE"
                       :group="this.$enum.FINANCIAL_TYPE" clearable>
            </mj-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="协议编号">
            <mj-input v-model="search.contract" placeholder="协议编号" clearable>
            </mj-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
        ...
        <el-table-column fixed="right" label="操作" align="center" width="160">
          <template slot-scope="scope">
            ...
            <el-tooltip content="财务放款">
              <el-button size="small" v-if="scope.row.paymentStatus=='UN_PAY' || scope.row.paymentStatus=='PAY_FAIL'"
                         @click="handleLoan(scope.row)">财务放款
              </el-button>
            </el-tooltip>
          </template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      setTimeout(this.getData(this.search.pageSize, this.search.pageNumber),
        1000);
    },
    methods: {
