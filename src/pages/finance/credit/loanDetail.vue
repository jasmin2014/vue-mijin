      ...
      <div v-if="type!='VIEW'" class="info" style="margin-top: 28px">
        <el-row>
          <el-table :data="userInfo" border class="table-center">
            <el-table-column label="用户申请金额" align="center" prop="applicationAmount">
            </el-table-column>
            <el-table-column label="实际放款金额" align="center" prop="paymentAmount"></el-table-column>
            <el-table-column label="选择放款账户" align="center" prop="fromAccountName"></el-table-column>
            <el-table-column label="账户余额" align="center" prop="accountBalance"></el-table-column>
          </el-table>
        </el-row>
